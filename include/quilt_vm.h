/* quilt_vm.h — The 5-opcode Quilt VM in C, on ESP32.
 *
 ...
 *   8. The bus
 *
 * This is the ESP32 port of /workspace/quilt-vm-c/. The same
 * struct, the same five functions, the same substrate. The
 * only change is the platform underneath. The opcodes are
 * the size.
 */
#ifndef QUILT_VM_H
#define QUILT_VM_H
...
struct qvm {
    qvm_thing_t **things;     /* Array of things */
    size_t n_things;
